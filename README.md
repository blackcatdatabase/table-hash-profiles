...
- Pkg folder: [packages\hash-profiles](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\hash-profiles)
...
graph LR
  ...
  hash_profiles["hash_profiles"]:::center
  hash_profiles -->|FK| crypto_algorithms["crypto_algorithms"]:::link
  field_hash_policies["field_hash_policies"]:::inbound -->|FK| hash_profiles
...
- Inbound (relies on this): "field_hash_policies"
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package hash-profiles -Apply
