...
| Pkg folder | [packages\hash-profiles](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\hash-profiles) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package hash-profiles -Apply
