...
use BlackCat\Database\Packages\HashProfiles\Repository\HashProfileRepository;
...
{
    private HashProfileRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new HashProfileRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\HashProfiles\Dto\HashProfileDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\HashProfiles\Dto\HashProfileDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\HashProfiles\Dto\HashProfileDto|null
    {
