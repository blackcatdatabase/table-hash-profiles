...
namespace BlackCat\Database\Packages\HashProfiles;
...
use BlackCat\Database\Packages\HashProfiles\Repository\HashProfileRepository as GeneratedRepository;
...
{
  private HashProfileRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof HashProfileRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected HashProfileRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\HashProfiles\Dto\HashProfileDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\HashProfiles\Dto\HashProfileDto|null { return $this->repo->getById($id, $asDto); }
