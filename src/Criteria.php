...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'name', 'algo_id', 'output_len', 'params', 'status', 'created_at' ];
    }
...
{
    return [ 'id', 'name', 'algo_id', 'output_len', 'status', 'created_at' ];
}
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\HashProfiles\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\HashProfiles\Definitions::softDeleteColumn();
