...
final class HashProfilesModule implements ModuleInterface
{
    public function name(): string { return 'table-hash_profiles'; }
    public function table(): string { return 'hash_profiles'; }
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_hp_algo_status' ];
        $expectedFk  = [ 'fk_hp_algo' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_hp_algo_status' ],
            'foreignKeys' => [ 'fk_hp_algo' ],
        ];
    }
}
