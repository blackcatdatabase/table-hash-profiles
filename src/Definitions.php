...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'hash_profiles'; }
    public static function contractView(): string { return 'vw_hash_profiles'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'name', 'algo_id', 'output_len', 'params', 'status', 'created_at' ]; }
    ...
    public static function jsonColumns(): array { return [ 'params' ]; }

    /** @return string[] List of numeric columns (generator heuristic; no runtime DB queries). */
    public static function intColumns(): array { return [ 'id', 'algo_id', 'output_len' ]; }
