...
namespace BlackCat\Database\Packages\HashProfiles\Mapper;

use BlackCat\Database\Packages\HashProfiles\Dto\HashProfileDto;
use BlackCat\Database\Packages\HashProfiles\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO HashProfileDto:
 ...
 */
final class HashProfileDtoMapper
{
    /** @var array<string,string> Column -> DTO property */
    private const COL_TO_PROP = [ 'id' => 'id', 'name' => 'name', 'algo_id' => 'algoId', 'output_len' => 'outputLen', 'params' => 'params', 'status' => 'status', 'created_at' => 'createdAt' ];

    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'algo_id', 'output_len' ];
    /** @var string[] */
    private const FLOAT_COLS  = [];
    /** @var string[] */
    private const JSON_COLS   = [ 'params' ];
    /** @var string[] */
     ...
     * @return HashProfileDto
     */
    public static function fromRow(array $row): HashProfileDto
    {
        /** @var HashProfileDto */
        return DtoHydrator::fromRow(
            HashProfileDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?HashProfileDto
    {
     ...
     *
     * @param HashProfileDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(HashProfileDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(HashProfileDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(HashProfileDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,HashProfileDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,HashProfileDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(HashProfileDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,HashProfileDto>
     */
